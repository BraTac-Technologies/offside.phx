defmodule OffsidePhxWeb.AdminAuthTest do
  use OffsidePhxWeb.ConnCase, async: true

  alias OffsidePhx.Accounts
  alias OffsidePhxWeb.AdminAuth
  import OffsidePhx.AccountsFixtures

  @remember_me_cookie "_offside_phx_web_admin_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OffsidePhxWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OffsidePhxWeb.Endpoint.subscribe(live_socket_id)
