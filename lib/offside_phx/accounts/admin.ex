defmodule OffsidePhx.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, OffsidePhx.Repo)
  ...
  """
  def valid_password?(%OffsidePhx.Accounts.Admin{hashed_password: hashed_password}, password)
